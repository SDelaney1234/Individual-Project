...
<script type="text/javascript">
  ...
  export default ({
    ...
    data() {
        ...
        const fname = accountToEdit.firstname;
        const sname = accountToEdit.surname;
        const acc = accountToEdit.accountnumber;
    return{
        fname,
        sname,
        acc
    ...
    methods:{
      editAccount(){
        axios.put('http://localhost:8080/accounts/update/' + this.id , {
